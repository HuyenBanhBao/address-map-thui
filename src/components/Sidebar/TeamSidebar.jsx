            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Box sx={{ flex: 1, minWidth: 0 }}>
                            <Typography
                                sx={{ fontFamily: fonts.display, fontSize: 13, fontWeight: 800, color: "inherit" }}
                            >
                                Đại nhân order
                            </Typography>
                            <Typography
                            ...
                            >
                                {orderedRecipes.length
                                    ? `${orderedRecipes.length} món đang chờ`
                                    : "Chưa có món được gọi"}
                            </Typography>
                        </Box>
                        <Box
                            sx={{
                    ...
                    >
                        <Typography
                            sx={{ mt: 0.35, px: 0.2, fontFamily: fonts.display, fontSize: 12, color: colors.text }}
                        >
